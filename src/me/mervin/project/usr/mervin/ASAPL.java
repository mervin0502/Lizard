...
/*		String srcDir = "../data/AS-2009-2012/all/";
		...
		new PCB().script(new Network(srcDir+Thread.currentThread().getName()+".txt", NetType.INDIRECTED, NumberType.INTEGER), dstDir, Thread.currentThread().getName());
	*/
		String srcFile = "../data/AS-2009-2012/all/1.txt";
//		Network net = new Network(srcFile, NetType.INDIRECTED, NumberType.INTEGER);
