...
import me.mervin.util.FileTool;
 ...
 /**
 *   SingleFileASPath.java
 *    
 *  @author Mervin.Wong  DateTime 2014年4月7日 下午9:23:03    
 *  @version 0.4.0
 */
public class SingleFileASPath {
	...
	public SingleFileASPath(String srcDir, String dstDir, String name, String logFile){
		this.srcDir = srcDir;
		this.dstDir = dstDir;
		this.name = name;
...
/*		String srcDir = "/media/文档/data/RV/2006/";
		String dstDir = "/media/娱乐/data/res/2006/";
		String name = "rib.20060204.0056";
		String logFile="/media/娱乐/data/res/2006/log.txt";*/
		String srcDir = "/home/mervin/tools/zebra-dump-parser/";
		String dstDir = "/home/mervin/tools/zebra-dump-parser/";
		String name = "rib.20110605.1200.txt";
		String logFile="/home/mervin/tools/zebra-dump-parser/log.txt";
		SingleFileASPath sf = new SingleFileASPath(srcDir, dstDir, name, logFile);
		sf.script();
	}
}
